...
namespace NovoRad.Migrations
{
    ...
    [Migration("20221025173655_AddAnexoArquivo")]
    partial class AddAnexoArquivo
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NovoRad.Models.AnexoArquivo", b =>
                {
                    b.Property<int>("AnexoArquivoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int?>("TipoAnexoArquivoId")
                        .HasColumnType("int");

                    b.Property<int>("TipoAnexoId")
                        .HasColumnType("int");

                    b.HasKey("AnexoArquivoId");

                    b.HasIndex("OcorrenciaId");

                    b.HasIndex("TipoAnexoArquivoId");

                    b.ToTable("AnexoArquivo");
                });
            ...
            modelBuilder.Entity("NovoRad.Models.TipoAnexoArquivo", b =>
                {
                    b.Property<int>("TipoAnexoArquivoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("NomeTipoAnexoArquivo")
                        .HasColumnType("varchar(100)");

                    b.HasKey("TipoAnexoArquivoId");

                    b.ToTable("TipoAnexoArquivo");
                });
            ...
            modelBuilder.Entity("NovoRad.Models.AnexoArquivo", b =>
                {
                    b.HasOne("NovoRad.Models.Ocorrencia", "Ocorrencia")
                        .WithMany("AnexoArquivo")
                        .HasForeignKey("OcorrenciaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NovoRad.Models.TipoAnexoArquivo", "TipoAnexoArquivo")
                        .WithMany("AnexoArquivo")
                        .HasForeignKey("TipoAnexoArquivoId");

                    b.Navigation("Ocorrencia");

                    b.Navigation("TipoAnexoArquivo");
                });
