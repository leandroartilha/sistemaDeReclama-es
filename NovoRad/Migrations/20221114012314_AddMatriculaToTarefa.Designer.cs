...
namespace NovoRad.Migrations
{
    ...
    [Migration("20221114012314_AddMatriculaToTarefa")]
    partial class AddMatriculaToTarefa
    {
            ...
            modelBuilder.Entity("NovoRad.Models.Tarefa", b =>
                {
                    ...
                    b.Property<int?>("MatriculaUsuarioId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NovoRad.Models.Tarefa", b =>
                {
                    ...
                    b.HasOne("NovoRad.Models.Usuario", "MatriculaUsuario")
                        .WithMany()
                        .HasForeignKey("MatriculaUsuarioId");
