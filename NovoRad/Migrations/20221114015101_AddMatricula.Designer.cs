...
namespace NovoRad.Migrations
{
    ...
    [Migration("20221114015101_AddMatricula")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NovoRad.Models.Anexo", b =>
                {
                    ...
                    b.Property<string>("NomeAnexoUpload")
                        .HasColumnType("varchar(100)");
                    ...
                    b.Property<int?>("TipoAnexoUploadId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NovoRad.Models.DiasPrazo", b =>
                {
                    ...
                    b.Property<string>("NomeDiasPrazo")
                        .HasColumnType("varchar(50)");
            ...
            modelBuilder.Entity("NovoRad.Models.Endereco", b =>
                {
            ...
            modelBuilder.Entity("NovoRad.Models.Tarefa", b =>
                {
                    ...
                    b.Property<string>("MatriculaUsuarioId")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("MatriculaUsuarioUsuarioId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MatriculaUsuarioUsuarioId");
            ...
            modelBuilder.Entity("NovoRad.Models.TipoAnexo", b =>
                {
                    ...
                    b.Property<string>("NomeTipoAnexoUpload")
                        .HasColumnType("varchar(100)");
            ...
            modelBuilder.Entity("NovoRad.Models.Endereco", b =>
                {
                    b.HasOne("NovoRad.Models.Envolvido", "Envolvido")
                        .WithMany("Endereco")
                        .HasForeignKey("EnvolvidoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("NovoRad.Models.Tarefa", b =>
                {
                    ...
                    b.HasOne("NovoRad.Models.Usuario", "MatriculaUsuario")
                        .WithMany()
                        .HasForeignKey("MatriculaUsuarioUsuarioId");
